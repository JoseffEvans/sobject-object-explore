...
async function initInMemeory() {
    await db.initDatabase(null!, true, ":memory:");
}
...
function getRealCaseData(): SObject {
    ...
    "result": {
      ...
      "childRelationships": [
        ...
        {
          "cascadeDelete": false,
          "childSObject": "CaseHistory2ChangeEvent",
          "deprecatedAndHidden": false,
          "field": "CaseId",
          "junctionIdListNames": [],
          "junctionReferenceTo": [],
        ...
        {
          "cascadeDelete": true,
          "childSObject": "CaseRelatedIssue",
          "deprecatedAndHidden": false,
          "field": "CaseId",
          "junctionIdListNames": [],
          "junctionReferenceTo": [],
          "relationshipName": "CaseRelatedIssues",
          "restrictedDelete": false
        },
        {
          "cascadeDelete": false,
          "childSObject": "CaseRelatedIssueChangeEvent",
          "deprecatedAndHidden": false,
          "field": "CaseId",
          "junctionIdListNames": [],
          "junctionReferenceTo": [],
        ...
        {
          "cascadeDelete": true,
          "childSObject": "ChangeRequestRelatedIssue",
          "deprecatedAndHidden": false,
          "field": "RelatedIssueId",
          "junctionIdListNames": [],
          "junctionReferenceTo": [],
          "relationshipName": "ChangeRequestRelatedIssues",
          "restrictedDelete": false
        },
        {
          "cascadeDelete": false,
          "childSObject": "ChangeRequestRelatedIssueChangeEvent",
          "deprecatedAndHidden": false,
          "field": "RelatedIssueId",
          "junctionIdListNames": [],
          "junctionReferenceTo": [],
      ...
      "recordTypeInfos": [
        {
          ...
          "urls": {
            "layout": "/services/data/v62.0/sobjects/Case/describe/layouts/012000000000000AAA"
          }
        }
      ],
      "replicateable": true,
      ...
      "supportedScopes": [
        ...
        {
          "label": "My role-based team's cases",
          "name": "team_by_role"
        },
        {
          "label": "User owned cases",
          "name": "user_owned"
        }
      ],
      "triggerable": true,
      ...
      "updateable": true,
      "urls": {
        "rowTemplate": "/services/data/v62.0/sobjects/Case/{ID}",
        "approvalLayouts": "/services/data/v62.0/sobjects/Case/describe/approvalLayouts",
        "uiDetailTemplate": "https://cunning-panda-lg1nbg-dev-ed.trailblaze.my.salesforce.com/{ID}",
        "quickActions": "/services/data/v62.0/sobjects/Case/quickActions",
        "layouts": "/services/data/v62.0/sobjects/Case/describe/layouts",
        "compactLayouts": "/services/data/v62.0/sobjects/Case/describe/compactLayouts",
        "uiEditTemplate": "https://cunning-panda-lg1nbg-dev-ed.trailblaze.my.salesforce.com/{ID}/e",
        "caseArticleSuggestions": "/services/data/v62.0/sobjects/Case/suggestedArticles",
        "caseRowArticleSuggestions": "/services/data/v62.0/sobjects/Case/{ID}/suggestedArticles",
        "listviews": "/services/data/v62.0/sobjects/Case/listviews",
        "describe": "/services/data/v62.0/sobjects/Case/describe",
        "uiNewRecord": "https://cunning-panda-lg1nbg-dev-ed.trailblaze.my.salesforce.com/500/e",
        "sobject": "/services/data/v62.0/sobjects/Case"
      }
    },
    "warnings": []
  }`).result;
